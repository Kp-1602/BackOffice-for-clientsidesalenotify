...
namespace BackOffice.Controllers
{
    public class AspNetUserRolesController : Controller
    {
        ...
        public AspNetUserRolesController(/*CCQ3_Team1_ProjectContext context*/)
        {
            //_context = context;
        }
        ...
        {
            var cCQ3_Team1_ProjectContext = _context.AspNetUserRoles.Include(a => a.Role).Include(a => a.User);
            return View(await cCQ3_Team1_ProjectContext.ToListAsync());
        }
